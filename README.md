...
1. Edit `dnd-display.env` with your Home Assistant URL and token.
...
> **Note:** Environment variables in `.bashrc` won't work with systemd services. The service loads variables from `dnd-display.env` instead.
